var plugins = [{
      ...
      plugin: require('/Users/seonae/hyegithub/hye-design.github.io/node_modules/gatsby-plugin-mdx/gatsby-ssr.js'),
      ...
      plugin: require('/Users/seonae/hyegithub/hye-design.github.io/node_modules/gatsby-plugin-react-helmet/gatsby-ssr.js'),
      options: {"plugins":[]},
    },{
      name: 'gatsby-plugin-theme-ui',
      plugin: require('/Users/seonae/hyegithub/hye-design.github.io/node_modules/gatsby-plugin-theme-ui/gatsby-ssr.js'),
      options: {"plugins":[]},
    },{
      name: 'gatsby-omni-font-loader',
      plugin: require('/Users/seonae/hyegithub/hye-design.github.io/node_modules/gatsby-omni-font-loader/gatsby-ssr.js'),
      ...
      plugin: require('/Users/seonae/hyegithub/hye-design.github.io/node_modules/gatsby-plugin-sitemap/gatsby-ssr.js'),
      options: {"plugins":[],"output":"/sitemap","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }","excludes":[]},
    },{
      name: 'gatsby-plugin-manifest',
      plugin: require('/Users/seonae/hyegithub/hye-design.github.io/node_modules/gatsby-plugin-manifest/gatsby-ssr.js'),
      ...
      plugin: require('/Users/seonae/hyegithub/hye-design.github.io/node_modules/gatsby-plugin-feed/gatsby-ssr.js'),
      options: {"plugins":[],"query":"\n          {\n            site {\n              siteMetadata {\n                title: siteTitle\n                description: siteDescription\n                siteUrl\n                site_url: siteUrl\n              }\n            }\n          }\n        ","feeds":[{"query":"\n              {\n                allPost(sort: { fields: date, order: DESC }) {\n                  nodes {\n                    title\n                    date(formatString: \"MMMM D, YYYY\")\n                    excerpt\n                    slug\n                  }\n                }\n              }\n            ","output":"rss.xml","title":"Minimal Blog - @lekoarts/gatsby-theme-minimal-blog"}]},
    },{
      name: 'gatsby-plugin-gatsby-cloud',
      plugin: require('/Users/seonae/hyegithub/hye-design.github.io/node_modules/gatsby-plugin-gatsby-cloud/gatsby-ssr.js'),
      options: {"plugins":[]},
    }]
/* global plugins */
