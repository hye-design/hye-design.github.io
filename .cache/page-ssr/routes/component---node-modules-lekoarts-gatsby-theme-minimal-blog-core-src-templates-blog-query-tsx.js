...
const Blog = ({
  ...
  return (0,theme_ui_esm/* jsx */.tZ)(layout/* default */.Z, null, (0,theme_ui_esm/* jsx */.tZ)(seo/* default */.Z, {
    title: "Blog"
  ...
  }, "Blog"), (0,theme_ui_esm/* jsx */.tZ)(gatsby_browser_entry.Link, {
    sx: t => {
      var _t$styles;
    ...
    to: (0,replaceSlashes/* default */.Z)(`/${basePath}/${tagsPath}`)
  }, "View all tags")), (0,theme_ui_esm/* jsx */.tZ)(listing/* default */.Z, {
    posts: posts,
    sx: {
      mt: [4, 5]
    }
...
function MinimalBlogCoreBlog(_ref) {
  ...
  return /*#__PURE__*/index_js_.createElement(blog, Object.assign({
    posts: allPost.nodes
  }, props));
}
