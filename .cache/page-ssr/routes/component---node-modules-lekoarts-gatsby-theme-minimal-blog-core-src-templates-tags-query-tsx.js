...
const Tags = ({
  ...
  return (0,theme_ui_esm/* jsx */.tZ)(layout/* default */.Z, null, (0,theme_ui_esm/* jsx */.tZ)(seo/* default */.Z, {
    ...
    as: "h1",
    variant: "styles.h1"
  }, "Tags"), (0,theme_ui_esm/* jsx */.tZ)(theme_ui_components_esm/* Box */.xu, {
    mt: [4, 5]
  }, list.map(listItem => (0,theme_ui_esm/* jsx */.tZ)(theme_ui_components_esm/* Flex */.kC, {
    ...
    to: (0,replaceSlashes/* default */.Z)(`/${basePath}/${tagsPath}/${lodash_kebabcase_default()(listItem.fieldValue)}`)
  }, listItem.fieldValue, " ", (0,theme_ui_esm/* jsx */.tZ)("span", {
    sx: {
      color: `secondary`
    }
  }, "(", listItem.totalCount, ")"))))));
...
function MinimalBlogCoreTags(_ref) {
  ...
  return /*#__PURE__*/index_js_.createElement(tags, Object.assign({
    list: allPost.group
  }, props));
}
