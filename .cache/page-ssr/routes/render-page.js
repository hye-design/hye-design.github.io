...
var emotion_sheet_esm = __webpack_require__(16166);
...
/* harmony default export */ const weak_memoize_esm = (weakMemoize);
...
/* harmony export */ });
/* unused harmony exports C, _, a, b, d, u */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(57423);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _emotion_cache__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1323);
/* harmony import */ var _emotion_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(74577);
/* harmony import */ var _emotion_serialize__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(27912);
...
/* harmony export */ });
/* unused harmony exports ClassNames, createElement, css */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(57423);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _emotion_cache__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1323);
/* harmony import */ var _emotion_element_570fe3bb_esm_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(21178);
/* harmony import */ var _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(67154);
...
/* harmony import */ var _emotion_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(74577);
/* harmony import */ var _emotion_serialize__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(27912);
/* harmony import */ var _emotion_sheet__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(16166);
...
var jsx = function jsx(type, props) {
  ...
  if (props == null || !_emotion_element_570fe3bb_esm_js__WEBPACK_IMPORTED_MODULE_6__.h.call(props, 'css')) {
    // $FlowFixMe
  ...
  createElementArgArray[0] = _emotion_element_570fe3bb_esm_js__WEBPACK_IMPORTED_MODULE_6__.E;
  createElementArgArray[1] = (0,_emotion_element_570fe3bb_esm_js__WEBPACK_IMPORTED_MODULE_6__.c)(type, props);
...
var Global = /* #__PURE__ */(0,_emotion_element_570fe3bb_esm_js__WEBPACK_IMPORTED_MODULE_6__.w)(function (props, cache) {
  if (false) {}

  var styles = props.styles;
  var serialized = (0,_emotion_serialize__WEBPACK_IMPORTED_MODULE_5__/* .serializeStyles */ .O)([styles], undefined, (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_emotion_element_570fe3bb_esm_js__WEBPACK_IMPORTED_MODULE_6__.T));

  if (!_emotion_element_570fe3bb_esm_js__WEBPACK_IMPORTED_MODULE_6__.i) {
    var _ref;
...
var emotion_element_570fe3bb_esm = __webpack_require__(21178);
...
var emotion_serialize_esm = __webpack_require__(27912);
...
var _invariant = __webpack_require__(46128);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(57423);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _theme_ui_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(92637);
/* harmony import */ var _theme_ui_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(33431);
/* harmony import */ var _emotion_react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(16657);
...
var TopLevelColorModeProvider = function TopLevelColorModeProvider(_ref) {
  ...
  if (false) { var _outerTheme$colors; }
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "nV": () => (/* binding */ theme_ui_color_esm_tint),
  "DZ": () => (/* binding */ theme_ui_color_esm_transparentize)
});

// UNUSED EXPORTS: alpha, complement, darken, desaturate, getColor, grayscale, hue, invert, lighten, lightness, mix, rotate, saturate, saturation, shade
...
function mix(weight, color, otherColor) {
  ...
  var color1 = (0,esm_extends/* default */.Z)({}, parsedColor1, {
    alpha: typeof parsedColor1.alpha === 'number' ? parsedColor1.alpha : 1
  });

  var parsedColor2 = parseToRgb(otherColor);

  var color2 = (0,esm_extends/* default */.Z)({}, parsedColor2, {
...
(mix);
var polished_esm_mix$1 = curriedMix;
...
function polished_esm_setHue(hue, color) {
  if (color === 'transparent') return color;
  return toColorString(_extends({}, parseToHsl(color), {
    hue: parseFloat(hue)
  }));
...
function polished_esm_setLightness(lightness, color) {
  if (color === 'transparent') return color;
  return toColorString(_extends({}, parseToHsl(color), {
...
function polished_esm_setSaturation(saturation, color) {
  if (color === 'transparent') return color;
  return toColorString(_extends({}, parseToHsl(color), {
...
function shade(percentage, color) {
  if (color === 'transparent') return color;
  return polished_esm_mix$1(parseFloat(percentage), 'rgb(0, 0, 0)', color);
} // prettier-ignore
...
function tint(percentage, color) {
  if (color === 'transparent') return color;
  return polished_esm_mix$1(parseFloat(percentage), 'rgb(255, 255, 255)', color);
} // prettier-ignore
...
;// CONCATENATED MODULE: ./node_modules/@theme-ui/color/dist/theme-ui-color.esm.js
...
var getColor = function getColor(theme, color) {
  ...
  return (0,theme_ui_css_esm/* get */.U2)(theme, 'rawColors' in theme ? "rawColors." + color : "colors." + color, color);
};
/**
 * Darken a color by an amount 0–1
 */

var theme_ui_color_esm_darken = function darken(c, n) {
  return function (t) {
...
var theme_ui_color_esm_lighten = function lighten(c, n) {
  return function (t) {
...
var theme_ui_color_esm_desaturate = function desaturate(c, n) {
  return function (t) {
...
var theme_ui_color_esm_saturate = function saturate(c, n) {
  return function (t) {
...
var theme_ui_color_esm_shade = function shade(c, n) {
  return function (t) {
...
var theme_ui_color_esm_tint = function tint(c, n) {
  return function (t) {
    return curriedTint$1(n, getColor(t, c));
  };
};
var theme_ui_color_esm_transparentize = function transparentize(c, n) {
  return function (t) {
    return curriedTransparentize$1(n, getColor(t, c));
  };
};
/**
...
var theme_ui_color_esm_mix = function mix(a, b, n) {
  if (n === void 0) {
    n = 0.5;
  }
...
var theme_ui_color_esm_complement = function complement(c) {
  return function (t) {
...
var theme_ui_color_esm_invert = function invert(c) {
  return function (t) {
...
var theme_ui_color_esm_grayscale = function grayscale(c) {
  return theme_ui_color_esm_desaturate(c, 1);
};
...
// UNUSED EXPORTS: Alert, AspectImage, AspectRatio, Avatar, Badge, Button, Card, Checkbox, Close, Divider, Donut, Embed, Field, Grid, IconButton, Image, Input, Label, MenuButton, Message, NavLink, Paragraph, Progress, Radio, Select, Slider, Spinner, Switch, Textarea

// EXTERNAL MODULE: ./node_modules/@emotion/styled/dist/emotion-styled.esm.js + 2 modules
var emotion_styled_esm = __webpack_require__(19871);
// EXTERNAL MODULE: ./node_modules/@theme-ui/css/dist/theme-ui-css.esm.js
var theme_ui_css_esm = __webpack_require__(33431);
...
var object_assign = __webpack_require__(24852);
...
var index_esm_all = compose(space, typography, color, layout, flexbox, border, background, position, grid, shadow, buttonStyle, textStyle, colorStyle);
...
var _excluded = (/* unused pure expression or super */ null && (["width", "columns", "gap", "repeat"]));
...
var Text = /*#__PURE__*/index_js_default().forwardRef(function Text(props, ref) {
  return /*#__PURE__*/index_js_default().createElement(Box, theme_ui_components_esm_extends({
    as: "span",
    ref: ref,
    variant: "default"
...
var Heading = /*#__PURE__*/index_js_default().forwardRef(function Heading(props, ref) {
  return /*#__PURE__*/index_js_default().createElement(Box, theme_ui_components_esm_extends({
    ref: ref,
    as: "h2",
    variant: "heading"
...
var Container = /*#__PURE__*/index_js_default().forwardRef(function Container(props, ref) {
  return /*#__PURE__*/index_js_default().createElement(Box, theme_ui_components_esm_extends({
    ref: ref,
    variant: "container"
  }, props, {
...
const package_namespaceObject = {"i8":"11.8.1"};
// EXTERNAL MODULE: ./node_modules/@theme-ui/css/dist/theme-ui-css.esm.js
var theme_ui_css_esm = __webpack_require__(33431);
;// CONCATENATED MODULE: ./node_modules/@theme-ui/parse-props/dist/theme-ui-parse-props.esm.js
...
/* harmony default export */ const theme_ui_parse_props_esm = (parseProps);
...
var jsx = function jsx(type, props) {
  ...
  return emotion_react_esm/* jsx.apply */.tZ.apply(void 0, [type, theme_ui_parse_props_esm(props)].concat(children));
};
/**
...
var __ThemeUIContext = /*#__PURE__*/(0,index_js_.createContext)(__themeUiDefaultContextValue);
var useThemeUI = function useThemeUI() {
  return (0,index_js_.useContext)(__ThemeUIContext);
};
...
var __ThemeUIInternalBaseThemeProvider = function __ThemeUIInternalBaseThemeProvider(_ref) {
  var context = _ref.context,
      children = _ref.children;
  return jsx(emotion_element_570fe3bb_esm.T.Provider, {
    value: context.theme
...
var _react = _interopRequireDefault(__webpack_require__(57423));

var _reachRouter = __webpack_require__(23631);

var _parsePath = __webpack_require__(61752);

exports.parsePath = _parsePath.parsePath;

var _isLocalLink = __webpack_require__(84587);

var _rewriteLinkPath = __webpack_require__(80349);
...
var _utils = __webpack_require__(51122);

var _applyTrailingSlashOption = __webpack_require__(64506);

var _parsePath2 = __webpack_require__(61752);

var _isLocalLink = __webpack_require__(84587);

var _ = __webpack_require__(38037);
...
var React = _interopRequireWildcard(__webpack_require__(57423));
...
var _react = __webpack_require__(57423);
...
exports.components={"component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-blog-query-tsx":()=>__webpack_require__.e(/* import() | component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-blog-query-tsx */ 303).then(__webpack_require__.bind(__webpack_require__, 47047)),"component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-homepage-query-tsx":()=>__webpack_require__.e(/* import() | component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-homepage-query-tsx */ 366).then(__webpack_require__.bind(__webpack_require__, 54265)),"component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-page-query-tsx":()=>__webpack_require__.e(/* import() | component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-page-query-tsx */ 677).then(__webpack_require__.bind(__webpack_require__, 63904)),"component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-post-query-tsx":()=>__webpack_require__.e(/* import() | component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-post-query-tsx */ 688).then(__webpack_require__.bind(__webpack_require__, 16033)),"component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-tags-query-tsx":()=>__webpack_require__.e(/* import() | component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-tags-query-tsx */ 726).then(__webpack_require__.bind(__webpack_require__, 4691)),"component---src-pages-404-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-404-jsx */ 256).then(__webpack_require__.bind(__webpack_require__, 37291))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-mdx',plugin:__webpack_require__(82276),options:{"plugins":[],"lessBabel":true,"extensions":[".mdx",".md"],"gatsbyRemarkPlugins":[{"resolve":"/Users/seonae/hyegithub/hye-design.github.io/node_modules/gatsby-remark-images","id":"4e9ee617-0e6c-5281-a705-2e6844a4e207","name":"gatsby-remark-images","version":"6.9.0","modulePath":"/Users/seonae/hyegithub/hye-design.github.io/node_modules/gatsby-remark-images/index.js","pluginOptions":{"plugins":[],"maxWidth":960,"quality":90,"linkImagesToOriginal":false,"backgroundColor":"transparent"},"nodeAPIs":["pluginOptionsSchema"],"browserAPIs":["onRouteUpdate"],"ssrAPIs":[]}],"defaultLayouts":{},"remarkPlugins":[],"rehypePlugins":[],"mediaTypes":["text/markdown","text/x-markdown"],"root":"/Users/seonae/hyegithub/hye-design.github.io","commonmark":false}},{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(21674),options:{"plugins":[]}},{name:'gatsby-plugin-theme-ui',plugin:__webpack_require__(15124),options:{"plugins":[]}},{name:'gatsby-omni-font-loader',plugin:__webpack_require__(31351),options:{"plugins":[],"enableListener":true,"preconnect":["https://fonts.gstatic.com"],"interval":300,"timeout":30000,"web":[{"name":"IBM Plex Sans","file":"https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:wght@400;500;600;700&display=swap"}]}},{name:'gatsby-plugin-sitemap',plugin:__webpack_require__(64988),options:{"plugins":[],"output":"/sitemap","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }","excludes":[]}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(85822),options:{"plugins":[],"name":"minimal-blog - @lekoarts/gatsby-theme-minimal-blog","short_name":"minimal-blog","description":"Typography driven, feature-rich blogging theme with minimal aesthetics. Includes tags/categories support and extensive features for code blocks such as live preview, line numbers, and code highlighting.","start_url":"/","background_color":"#fff","display":"standalone","icons":[{"src":"/android-chrome-192x192.png","sizes":"192x192","type":"image/png"},{"src":"/android-chrome-512x512.png","sizes":"512x512","type":"image/png"}],"legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":null}},{name:'gatsby-plugin-feed',plugin:__webpack_require__(86155),options:{"plugins":[],"query":"\n          {\n            site {\n              siteMetadata {\n                title: siteTitle\n                description: siteDescription\n                siteUrl\n                site_url: siteUrl\n              }\n            }\n          }\n        ","feeds":[{"query":"\n              {\n                allPost(sort: { fields: date, order: DESC }) {\n                  nodes {\n                    title\n                    date(formatString: \"MMMM D, YYYY\")\n                    excerpt\n                    slug\n                  }\n                }\n              }\n            ","output":"rss.xml","title":"Minimal Blog - @lekoarts/gatsby-theme-minimal-blog"}]}},{name:'gatsby-plugin-gatsby-cloud',plugin:__webpack_require__(45456),options:{"plugins":[]}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
var utils = __webpack_require__(51122);
...
var public_page_renderer = __webpack_require__(82743);
...
var find_path = __webpack_require__(39755);
...
const getFontConfig = (preconnectConfig, preloadConfig, renderBlockingFonts) => {
  ...
  if (arrayCheck(preconnectConfig)) {
    preconnectConfig.forEach(href => {
      headComponents.push( /*#__PURE__*/index_js_default().createElement("link", {
        key: `preconnect-${href}`,
        rel: "preconnect",
        href: href,
        crossOrigin: "true"
  ...
  if (arrayCheck(renderBlockingFonts)) {
    renderBlockingFonts.forEach(({
      ...
      const key = Array.isArray(name) ? name.map(n => kebabCase(n)).join("-") : kebabCase(name);
      headComponents.push( /*#__PURE__*/index_js_default().createElement("link", {
...
;// CONCATENATED MODULE: ./node_modules/gatsby-omni-font-loader/generators/getTestFonts.tsx
...
const getTestFonts = fontNames => {
  ...
  fontNames.forEach(fontName => {
    fontConfig.push( /*#__PURE__*/index_js_default().createElement("span", {
...
;// CONCATENATED MODULE: ./node_modules/gatsby-omni-font-loader/utils/getFontNames.ts
...
const onRenderBody=({setHeadComponents,setPostBodyComponents},{enableListener,preconnect=[],preload=[],web=[],custom=[],mode=MODE_DEFAULT})=>{const allFonts=[...web,...custom];const allPreloads=preload.concat(getFontFiles(allFonts));const fontNames=getFontNames(allFonts);const preloadConfig=getFontConfig(preconnect,allPreloads,mode==="async"?[]:allFonts);if(enableListener&&Boolean(allFonts.length)&&mode==="async"){const testFontConfig=getTestFonts(fontNames);setPostBodyComponents(testFontConfig);}if(preloadConfig&&Boolean(preloadConfig.length)){setHeadComponents(preloadConfig);}};
...
"use strict";
var _interopRequireDefault=__webpack_require__(95318);var _extends2=_interopRequireDefault(__webpack_require__(67154));var _react=_interopRequireDefault(__webpack_require__(57423));var _gatsby=__webpack_require__(37533);var _internals=__webpack_require__(38524);// TODO: remove for v3
...
"use strict";
var _interopRequireDefault=__webpack_require__(95318);exports.__esModule=true;exports.defaultOptions=exports.runQuery=void 0;var _extends2=_interopRequireDefault(__webpack_require__(67154));var _objectWithoutPropertiesLoose2=_interopRequireDefault(__webpack_require__(37316));var _excluded=["query"];var runQuery=function runQuery(handler,query){return handler(query).then(function(r){if(r.errors){throw new Error(r.errors.join(", "));}return r.data;});};exports.runQuery=runQuery;var defaultOptions={// Override if you want to manually specify the RSS "generator" tag.
...
"use strict";
exports.__esModule=true;exports.wrapRootElement=void 0;var _gatsbyBrowser=__webpack_require__(5876);exports.wrapRootElement=_gatsbyBrowser.wrapRootElement;
...
"use strict";
var _interopRequireDefault=__webpack_require__(95318);var _path=_interopRequireDefault(__webpack_require__(71423));exports.favicons=[{src:`favicon-32x32.png`,sizes:`32x32`,type:`image/png`}];// default icons for generating icons
...
"use strict";
var _interopRequireDefault=__webpack_require__(95318);var React=_interopRequireWildcard(__webpack_require__(57423));var _gatsby=__webpack_require__(37533);var _common=__webpack_require__(25428);var _getManifestPathname=_interopRequireDefault(__webpack_require__(20292));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
"use strict";
exports.__esModule=true;exports["default"]=void 0;var _gatsby=__webpack_require__(37533);/**
...
"use strict";
var React=_interopRequireWildcard(__webpack_require__(57423));var _gatsby=__webpack_require__(37533);var _path=__webpack_require__(71423);function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: Remove for v3 - Fix janky path/asset prefixing
...
var theme_ui_core_esm = __webpack_require__(92637);
// EXTERNAL MODULE: ./node_modules/@theme-ui/css/dist/theme-ui-css.esm.js
var theme_ui_css_esm = __webpack_require__(33431);
// EXTERNAL MODULE: ./node_modules/@emotion/styled/dist/emotion-styled.esm.js + 2 modules
var emotion_styled_esm = __webpack_require__(19871);
...
var themed = function themed(key) {
  return function (_ref) {
    ...
    return (0,theme_ui_css_esm/* css */.iv)(_extends({}, (0,theme_ui_css_esm/* get */.U2)(theme, "styles." + key), extraStyles))(theme);
  };
}; // opt out of typechecking whenever `as` prop is used

var Themed = (0,emotion_styled_esm/* default */.Z)('div')(themed('div'));
/**
...
var Styled = (0,emotion_styled_esm/* default */.Z)('div')(themed('div'));
...
var warnStyled = function warnStyled(tag) {
  return function (props) {
    ...
    return /*#__PURE__*/(0,index_js_.createElement)(alias(tag), props);
  };
};
...
tags.forEach(function (tag) {
  // fixme?
  components[tag] = (0,emotion_styled_esm/* default */.Z)(alias(tag))(themed(tag));
  Themed[tag] = components[tag];
  Styled[tag] = (0,emotion_styled_esm/* default */.Z)(warnStyled(tag))(themed(tag));
});
...
var createComponents = function createComponents(comps) {
  ...
  componentKeys.forEach(function (key) {
    next[key] = (0,emotion_styled_esm/* default */.Z)(comps[key])(themed(key));
  });
  return next;
};
...
var MDXProvider = function MDXProvider(_ref2) {
  var components = _ref2.components,
      children = _ref2.children;
  var outer = (0,esm.useMDXComponents)();
  return (0,theme_ui_core_esm/* jsx */.tZ)(esm.MDXProvider, {
...
var ThemeProvider = function ThemeProvider(_ref2) {
  ...
  return /*#__PURE__*/index_js_default().createElement(theme_ui_core_esm/* ThemeProvider */.f6, {
    theme: theme
  }, /*#__PURE__*/index_js_default().createElement(theme_ui_color_modes_esm/* ColorModeProvider */.SG, null, isTopLevel && /*#__PURE__*/index_js_default().createElement(RootStyles, null), /*#__PURE__*/index_js_default().createElement(MDXProvider, {
...
;// CONCATENATED MODULE: ./node_modules/@theme-ui/preset-base/dist/theme-ui-preset-base.esm.js


function theme_ui_preset_base_esm_extends() {
  theme_ui_preset_base_esm_extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
  ...
  return theme_ui_preset_base_esm_extends.apply(this, arguments);
}
...
var base = makeTheme({
  ...
  styles: {
    ...
    h1: theme_ui_preset_base_esm_extends({}, heading, {
      fontSize: 5
    }),
    h2: theme_ui_preset_base_esm_extends({}, heading, {
      fontSize: 4
    }),
    h3: theme_ui_preset_base_esm_extends({}, heading, {
      fontSize: 3
    }),
    h4: theme_ui_preset_base_esm_extends({}, heading, {
      fontSize: 2
    }),
    h5: theme_ui_preset_base_esm_extends({}, heading, {
      fontSize: 1
    }),
    h6: theme_ui_preset_base_esm_extends({}, heading, {
      fontSize: 0
    }),
    p: {
      color: 'text',
...
/* harmony default export */ const theme_ui_preset_base_esm = (base);


;// CONCATENATED MODULE: ./node_modules/@theme-ui/preset-dark/dist/theme-ui-preset-dark.esm.js


var theme_ui_preset_dark_esm_heading = {
  fontFamily: 'heading',
  fontWeight: 'heading',
  lineHeight: 'heading'
};
var dark = makeTheme({
  ...
  text: {
    heading: theme_ui_preset_dark_esm_heading,
    display: {
...
/* harmony default export */ const theme_ui_preset_dark_esm = ((/* unused pure expression or super */ null && (dark)));


;// CONCATENATED MODULE: ./node_modules/@theme-ui/preset-deep/dist/theme-ui-preset-deep.esm.js


var theme_ui_preset_deep_esm_heading = {
  fontFamily: 'heading',
  fontWeight: 'heading',
  lineHeight: 'heading'
};
var deep = makeTheme({
  ...
  text: {
    heading: theme_ui_preset_deep_esm_heading,
    display: {
      variant: 'text.heading',
      fontSize: [5, 6],
      fontWeight: 'display',
...
/* harmony default export */ const theme_ui_preset_deep_esm = ((/* unused pure expression or super */ null && (deep)));


;// CONCATENATED MODULE: ./node_modules/@theme-ui/preset-funk/dist/theme-ui-preset-funk.esm.js



function theme_ui_preset_funk_esm_extends() {
  theme_ui_preset_funk_esm_extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
  ...
  return theme_ui_preset_funk_esm_extends.apply(this, arguments);
}

var funk = makeTheme(theme_ui_preset_funk_esm_extends({}, theme_ui_preset_base_esm, {
  fonts: {
  ...
  colors: theme_ui_preset_funk_esm_extends({}, theme_ui_preset_base_esm.colors, {
    primary: '#609',
    secondary: '#306'
  }),
  styles: theme_ui_preset_funk_esm_extends({}, theme_ui_preset_base_esm.styles)
}));

/* harmony default export */ const theme_ui_preset_funk_esm = ((/* unused pure expression or super */ null && (funk)));


;// CONCATENATED MODULE: ./node_modules/@theme-ui/preset-future/dist/theme-ui-preset-future.esm.js



function theme_ui_preset_future_esm_extends() {
  theme_ui_preset_future_esm_extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
  ...
  return theme_ui_preset_future_esm_extends.apply(this, arguments);
}

var future = makeTheme(theme_ui_preset_future_esm_extends({}, theme_ui_preset_base_esm, {
  colors: {
    text: '#000',
    background: '#fff',
    primary: '#11e',
...
/* harmony default export */ const theme_ui_preset_future_esm = ((/* unused pure expression or super */ null && (future)));


;// CONCATENATED MODULE: ./node_modules/@theme-ui/preset-roboto/dist/theme-ui-preset-roboto.esm.js



function theme_ui_preset_roboto_esm_extends() {
  theme_ui_preset_roboto_esm_extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
  ...
  return theme_ui_preset_roboto_esm_extends.apply(this, arguments);
}

var roboto = makeTheme(theme_ui_preset_roboto_esm_extends({}, theme_ui_preset_base_esm, {
  colors: {
    text: '#202124',
    background: '#fff',
    primary: '#1a73e8',
...
/* harmony default export */ const theme_ui_preset_roboto_esm = ((/* unused pure expression or super */ null && (roboto)));


;// CONCATENATED MODULE: ./node_modules/@theme-ui/preset-swiss/dist/theme-ui-preset-swiss.esm.js


var theme_ui_preset_swiss_esm_heading = {
  fontFamily: 'heading',
  fontWeight: 'heading',
  lineHeight: 'heading'
};
var swiss = makeTheme({
  ...
  text: {
    heading: theme_ui_preset_swiss_esm_heading,
    display: {
      variant: 'text.heading',
      fontSize: [5, 6],
      fontWeight: 'display',
...
/* harmony default export */ const theme_ui_preset_swiss_esm = ((/* unused pure expression or super */ null && (swiss)));


;// CONCATENATED MODULE: ./node_modules/@theme-ui/preset-system/dist/theme-ui-preset-system.esm.js


var theme_ui_preset_system_esm_heading = {
  fontFamily: 'heading',
  fontWeight: 'heading',
  lineHeight: 'heading'
};
var system = makeTheme({
  config: {
  ...
  text: {
    heading: theme_ui_preset_system_esm_heading,
    display: {
      variant: 'text.heading',
      fontSize: [5, 6],
      fontWeight: 'display',
...
/* harmony default export */ const theme_ui_preset_system_esm = ((/* unused pure expression or super */ null && (system)));


;// CONCATENATED MODULE: ./node_modules/@theme-ui/preset-tosh/dist/theme-ui-preset-tosh.esm.js


var theme_ui_preset_tosh_esm_heading = {
  fontFamily: 'heading',
  fontWeight: 'heading',
  lineHeight: 'heading'
};
var tosh = makeTheme({
  ...
  text: {
    heading: theme_ui_preset_tosh_esm_heading,
    display: {
      variant: 'text.heading',
      fontSize: [5, 6],
      fontWeight: 'display',
...
/* harmony default export */ const theme_ui_preset_tosh_esm = ((/* unused pure expression or super */ null && (tosh)));


;// CONCATENATED MODULE: ./node_modules/@theme-ui/preset-bootstrap/dist/theme-ui-preset-bootstrap.esm.js


function theme_ui_preset_bootstrap_esm_extends() {
  theme_ui_preset_bootstrap_esm_extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
  ...
  return theme_ui_preset_bootstrap_esm_extends.apply(this, arguments);
}
...
var colors = theme_ui_preset_bootstrap_esm_extends({}, baseColors, {
...
var theme_ui_preset_bootstrap_esm_heading = {
  fontFamily: 'heading',
  fontWeight: 'heading',
  lineHeight: 'heading',
  mt: 0,
...
var theme_ui_preset_bootstrap_esm_text = {
  heading: theme_ui_preset_bootstrap_esm_heading,
  display: display
};
var styles = makeStyles({
  ...
  h1: theme_ui_preset_bootstrap_esm_extends({}, theme_ui_preset_bootstrap_esm_heading, {
    fontSize: 7
  }),
  h2: theme_ui_preset_bootstrap_esm_extends({}, theme_ui_preset_bootstrap_esm_heading, {
    fontSize: 6
  }),
  h3: theme_ui_preset_bootstrap_esm_extends({}, theme_ui_preset_bootstrap_esm_heading, {
    fontSize: 5
  }),
  h4: theme_ui_preset_bootstrap_esm_extends({}, theme_ui_preset_bootstrap_esm_heading, {
    fontSize: 4
  }),
  h5: theme_ui_preset_bootstrap_esm_extends({}, theme_ui_preset_bootstrap_esm_heading, {
    fontSize: 3
  }),
  h6: theme_ui_preset_bootstrap_esm_extends({}, theme_ui_preset_bootstrap_esm_heading, {
    fontSize: 2
  }),
  blockquote: {
    fontSize: 3,
...
var bootstrap = makeTheme({
  ...
  shadows: shadows,
  radii: radii,
  text: theme_ui_preset_bootstrap_esm_text,
  styles: styles
});

/* harmony default export */ const theme_ui_preset_bootstrap_esm = ((/* unused pure expression or super */ null && (bootstrap)));


;// CONCATENATED MODULE: ./node_modules/@theme-ui/preset-bulma/dist/theme-ui-preset-bulma.esm.js


function theme_ui_preset_bulma_esm_extends() {
  theme_ui_preset_bulma_esm_extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
  ...
  return theme_ui_preset_bulma_esm_extends.apply(this, arguments);
}

var theme_ui_preset_bulma_esm_baseColors = {
  black: 'hsl(0, 0%, 4%)',
  blackBis: 'hsl(0, 0%, 7%)',
  blackTer: 'hsl(0, 0%, 14%)',
  // (sic)
...
var theme_ui_preset_bulma_esm_colors = theme_ui_preset_bulma_esm_extends({}, theme_ui_preset_bulma_esm_baseColors, {
  text: theme_ui_preset_bulma_esm_baseColors.greyDark,
  background: theme_ui_preset_bulma_esm_baseColors.white,
  primary: theme_ui_preset_bulma_esm_baseColors.blue,
  muted: theme_ui_preset_bulma_esm_baseColors.whiteTer,
  // bulma-specific
  info: theme_ui_preset_bulma_esm_baseColors.cyan,
  success: theme_ui_preset_bulma_esm_baseColors.green,
  warning: theme_ui_preset_bulma_esm_baseColors.yellow,
  danger: theme_ui_preset_bulma_esm_baseColors.red,
  light: theme_ui_preset_bulma_esm_baseColors.whiteTer,
  dark: theme_ui_preset_bulma_esm_baseColors.greyDarker,
  modes: {
    invert: {}
  }
});
var theme_ui_preset_bulma_esm_fonts = {
...
var theme_ui_preset_bulma_esm_fontSizes = ['0.75rem', '0.875rem', // tweener
'1rem', '1.25rem', '1.5rem', '1.75rem', '2rem', '2.5rem', '3rem'];
var theme_ui_preset_bulma_esm_fontWeights = {
  body: 400,
  heading: 700,
  bold: 700,
  light: 300,
...
var theme_ui_preset_bulma_esm_lineHeights = {
  body: 1.5,
  heading: 1.125
}; // guesstimate

var theme_ui_preset_bulma_esm_space = [0, 0.5, 1, 1.5, 2, 2.5, 3].map(function (n) {
  return n + 'rem';
});
var theme_ui_preset_bulma_esm_heading = {
  fontFamily: 'heading',
  fontWeight: 'heading',
  lineHeight: 'heading',
  m: 0,
...
var theme_ui_preset_bulma_esm_styles = makeStyles({
  root: {
    fontFamily: 'body',
    lineHeight: 'body',
    fontWeight: 'body'
  ...
  h1: theme_ui_preset_bulma_esm_extends({}, theme_ui_preset_bulma_esm_heading, {
    fontSize: 6,
    mt: 2
  }),
  h2: theme_ui_preset_bulma_esm_extends({}, theme_ui_preset_bulma_esm_heading, {
    fontSize: 5,
    mt: 2
  }),
  h3: theme_ui_preset_bulma_esm_extends({}, theme_ui_preset_bulma_esm_heading, {
    fontSize: 4,
    mt: 3
  }),
  h4: theme_ui_preset_bulma_esm_extends({}, theme_ui_preset_bulma_esm_heading, {
    fontSize: 3
  }),
  h5: theme_ui_preset_bulma_esm_extends({}, theme_ui_preset_bulma_esm_heading, {
    fontSize: 2
  }),
  h6: theme_ui_preset_bulma_esm_extends({}, theme_ui_preset_bulma_esm_heading, {
    fontSize: 1,
    mb: 2
  }),
  code: {},
...
var bulma = makeTheme({
  colors: theme_ui_preset_bulma_esm_colors,
  fonts: theme_ui_preset_bulma_esm_fonts,
  fontSizes: theme_ui_preset_bulma_esm_fontSizes,
  fontWeights: theme_ui_preset_bulma_esm_fontWeights,
  space: theme_ui_preset_bulma_esm_space,
  styles: theme_ui_preset_bulma_esm_styles
});

/* harmony default export */ const theme_ui_preset_bulma_esm = ((/* unused pure expression or super */ null && (bulma)));


;// CONCATENATED MODULE: ./node_modules/@theme-ui/preset-polaris/dist/theme-ui-preset-polaris.esm.js



function theme_ui_preset_polaris_esm_extends() {
  theme_ui_preset_polaris_esm_extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
  ...
  return theme_ui_preset_polaris_esm_extends.apply(this, arguments);
}

var theme_ui_preset_polaris_esm_text = 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", sans-serif';
var polaris = makeTheme(theme_ui_preset_polaris_esm_extends({}, theme_ui_preset_base_esm, {
  colors: {
    text: '#454f5b',
    background: '#fff',
    primary: '#5c6ac4',
  ...
  fonts: {
    body: theme_ui_preset_polaris_esm_text,
    heading: theme_ui_preset_polaris_esm_text,
    monospace: 'Menlo, monospace'
  },
  fontWeights: {
    body: 400,
...
/* harmony default export */ const theme_ui_preset_polaris_esm = ((/* unused pure expression or super */ null && (polaris)));
...
function theme_ui_preset_tailwind_esm_extends() {
  theme_ui_preset_tailwind_esm_extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
...
var theme_ui_preset_tailwind_esm_breakpoints = ['640px', '768px', '1024px', '1280px'];
var theme_ui_preset_tailwind_esm_baseColors = makeColorsScale({
...
var theme_ui_preset_tailwind_esm_colors = makeColorsScale(theme_ui_preset_tailwind_esm_extends({}, theme_ui_preset_tailwind_esm_baseColors, {
  grayDark: theme_ui_preset_tailwind_esm_baseColors.gray[8],
  text: theme_ui_preset_tailwind_esm_baseColors.gray[8],
  background: theme_ui_preset_tailwind_esm_baseColors.white,
  primary: theme_ui_preset_tailwind_esm_baseColors.blue[7],
  primaryHover: theme_ui_preset_tailwind_esm_baseColors.blue[8],
  secondary: theme_ui_preset_tailwind_esm_baseColors.gray[6],
  muted: theme_ui_preset_tailwind_esm_baseColors.gray[3],
  success: theme_ui_preset_tailwind_esm_baseColors.green[3],
  info: theme_ui_preset_tailwind_esm_baseColors.blue[4],
  warning: theme_ui_preset_tailwind_esm_baseColors.yellow[3],
  danger: theme_ui_preset_tailwind_esm_baseColors.red[3],
  light: theme_ui_preset_tailwind_esm_baseColors.gray[1],
  dark: theme_ui_preset_tailwind_esm_baseColors.gray[8],
  textMuted: theme_ui_preset_tailwind_esm_baseColors.gray[6]
}));
var baseFonts = {
...
var theme_ui_preset_tailwind_esm_fonts = theme_ui_preset_tailwind_esm_extends({}, baseFonts, {
  body: baseFonts.sans,
  heading: 'inherit',
  monospace: baseFonts.mono
});
var theme_ui_preset_tailwind_esm_fontSizes = ['0.875rem', '1rem', '1.25rem', '1.5rem', '1.875rem', '2.25rem', '3rem', '4rem', '4.5rem'];
var baseFontWeights = {
  hairline: 100,
  thin: 200,
  light: 300,
...
var theme_ui_preset_tailwind_esm_fontWeights = theme_ui_preset_tailwind_esm_extends({}, baseFontWeights, {
...
var theme_ui_preset_tailwind_esm_lineHeights = theme_ui_preset_tailwind_esm_extends({}, baseLineHeights, {
  body: baseLineHeights.relaxed,
  heading: baseLineHeights.tight
});
var theme_ui_preset_tailwind_esm_radii = {
  none: '0',
  sm: '0.125rem',
  default: '0.25rem',
  md: '0.375rem',
...
var theme_ui_preset_tailwind_esm_sizes = theme_ui_preset_tailwind_esm_extends({}, tailwindSpacing, tailwindMaxWidth, tailwindWidth, {
  full: '100%',
  screenHeight: '100vh',
  screenWidth: '100vw'
});
var theme_ui_preset_tailwind_esm_shadows = {
...
var theme_ui_preset_tailwind_esm_space = ['0', '0.25rem', '0.5rem', '1rem', '2rem', '4rem', '8rem', '16rem', '32rem'];
var zIndices = {
  auto: 'auto',
  '0': 0,
  '10': 10,
...
var theme_ui_preset_tailwind_esm_heading = {
  fontFamily: 'heading',
  fontWeight: 'heading',
  lineHeight: 'heading',
  m: 0,
...
var theme_ui_preset_tailwind_esm_styles = {
  root: {
    fontFamily: 'body',
    lineHeight: 'body',
    fontWeight: 'body'
  ...
  h1: theme_ui_preset_tailwind_esm_extends({}, theme_ui_preset_tailwind_esm_heading, {
    fontSize: 6,
    mt: 2
  }),
  h2: theme_ui_preset_tailwind_esm_extends({}, theme_ui_preset_tailwind_esm_heading, {
    fontSize: 5,
    mt: 2
  }),
  h3: theme_ui_preset_tailwind_esm_extends({}, theme_ui_preset_tailwind_esm_heading, {
    fontSize: 4,
    mt: 3
  }),
  h4: theme_ui_preset_tailwind_esm_extends({}, theme_ui_preset_tailwind_esm_heading, {
    fontSize: 3
  }),
  h5: theme_ui_preset_tailwind_esm_extends({}, theme_ui_preset_tailwind_esm_heading, {
    fontSize: 2
  }),
  h6: theme_ui_preset_tailwind_esm_extends({}, theme_ui_preset_tailwind_esm_heading, {
    fontSize: 1,
    mb: 2
  }),
  code: {},
...
var tailwind = makeTheme({
  ...
  breakpoints: theme_ui_preset_tailwind_esm_breakpoints,
  colors: theme_ui_preset_tailwind_esm_colors,
  fonts: theme_ui_preset_tailwind_esm_fonts,
  fontSizes: theme_ui_preset_tailwind_esm_fontSizes,
  fontWeights: theme_ui_preset_tailwind_esm_fontWeights,
  letterSpacings: letterSpacings,
  lineHeights: theme_ui_preset_tailwind_esm_lineHeights,
  sizes: theme_ui_preset_tailwind_esm_sizes,
  shadows: theme_ui_preset_tailwind_esm_shadows,
  space: theme_ui_preset_tailwind_esm_space,
  radii: theme_ui_preset_tailwind_esm_radii,
  zIndices: zIndices,
  styles: theme_ui_preset_tailwind_esm_styles,
  buttons: buttons,
  inputs: inputs,
...
/* harmony default export */ const theme_ui_preset_tailwind_esm = (tailwind);


;// CONCATENATED MODULE: ./node_modules/@theme-ui/preset-sketchy/dist/theme-ui-preset-sketchy.esm.js


function theme_ui_preset_sketchy_esm_extends() {
  theme_ui_preset_sketchy_esm_extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
  ...
  return theme_ui_preset_sketchy_esm_extends.apply(this, arguments);
}
...
var buttonStyles = theme_ui_preset_sketchy_esm_extends({}, defaultBorderStyles, {
...
var variants = {
  buttons: {
    ...
    danger: theme_ui_preset_sketchy_esm_extends({}, buttonStyles, {
      borderColor: 'primary',
      backgroundColor: 'primaryLight'
    }),
    info: theme_ui_preset_sketchy_esm_extends({}, buttonStyles, {
      borderColor: 'blueDark',
      backgroundColor: 'blue'
    }),
    warning: theme_ui_preset_sketchy_esm_extends({}, buttonStyles, {
      borderColor: 'yellowDark',
      backgroundColor: 'yellow'
    }),
    success: theme_ui_preset_sketchy_esm_extends({}, buttonStyles, {
  ...
  forms: {
    ...
    radio: theme_ui_preset_sketchy_esm_extends({
      bg: 'transparent',
      border: 'thin',
      borderRadius: 'circle'
    }, {
    ...
    checkbox: theme_ui_preset_sketchy_esm_extends({
      color: 'text',
  ...
  messages: {
    danger: theme_ui_preset_sketchy_esm_extends({}, defaultBorderStyles, {
      borderColor: 'primary',
      backgroundColor: 'primaryLight'
    }),
    info: theme_ui_preset_sketchy_esm_extends({}, defaultBorderStyles, {
      borderColor: 'blueDark',
      backgroundColor: 'blue'
    }),
    warning: theme_ui_preset_sketchy_esm_extends({}, defaultBorderStyles, {
      borderColor: 'yellowDark',
      backgroundColor: 'yellow'
    }),
    success: theme_ui_preset_sketchy_esm_extends({}, defaultBorderStyles, {
      borderColor: 'greenDark',
      backgroundColor: 'green'
    })
  },
...
var presetSketchy = theme_ui_preset_sketchy_esm_extends({}, scalesAndStyles, variants);

/* harmony default export */ const theme_ui_preset_sketchy_esm = ((/* unused pure expression or super */ null && (presetSketchy)));

;// CONCATENATED MODULE: ./node_modules/@theme-ui/presets/dist/theme-ui-presets.esm.js
...
;// CONCATENATED MODULE: ./node_modules/@lekoarts/gatsby-theme-minimal-blog/src/gatsby-plugin-theme-ui/index.js
const theme=(0,theme_ui_core_esm/* merge */.TS)(theme_ui_preset_tailwind_esm,{initialColorModeName:`light`,config:{useCustomProperties:true},colors:{primary:theme_ui_preset_tailwind_esm.colors.purple[7],secondary:`#5f6c80`,toggleIcon:theme_ui_preset_tailwind_esm.colors.gray[8],heading:theme_ui_preset_tailwind_esm.colors.black,divide:theme_ui_preset_tailwind_esm.colors.gray[4],modes:{dark:{text:theme_ui_preset_tailwind_esm.colors.gray[4],primary:theme_ui_preset_tailwind_esm.colors.purple[5],secondary:`#7f8ea3`,toggleIcon:theme_ui_preset_tailwind_esm.colors.gray[4],background:`#1A202C`,heading:theme_ui_preset_tailwind_esm.colors.white,divide:theme_ui_preset_tailwind_esm.colors.gray[8],muted:theme_ui_preset_tailwind_esm.colors.gray[8]}}},fonts:{body:`"IBM Plex Sans", -apple-system, BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,"Noto Sans",sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji"`},styles:{root:{color:`text`,backgroundColor:`background`,margin:0,padding:0,boxSizing:`border-box`,textRendering:`optimizeLegibility`,WebkitFontSmoothing:`antialiased`,MozOsxFontSmoothing:`grayscale`},p:{fontSize:[1,1,2],letterSpacing:`-0.003em`,lineHeight:`body`,"--baseline-multiplier":0.179,"--x-height-multiplier":0.35,wordBreak:`break-word`},ul:{li:{fontSize:[1,1,2],letterSpacing:`-0.003em`,lineHeight:`body`,"--baseline-multiplier":0.179,"--x-height-multiplier":0.35}},ol:{li:{fontSize:[1,1,2],letterSpacing:`-0.003em`,lineHeight:`body`,"--baseline-multiplier":0.179,"--x-height-multiplier":0.35}},h1:{variant:`text.heading`,fontSize:[5,6,6,7],mt:4},h2:{variant:`text.heading`,fontSize:[4,5,5,6],mt:4},h3:{variant:`text.heading`,fontSize:[3,4,4,5],mt:4},h4:{variant:`text.heading`,fontSize:[2,3,3,4],mt:3},h5:{variant:`text.heading`,fontSize:[1,2,2,3],mt:3},h6:{variant:`text.heading`,fontSize:1,mb:2},blockquote:{borderLeftColor:`primary`,borderLeftStyle:`solid`,borderLeftWidth:`6px`,mx:0,pl:4,p:{fontStyle:`italic`}},table:{width:`100%`,my:4,borderCollapse:`separate`,borderSpacing:0,[[`th`,`td`]]:{textAlign:`left`,py:`4px`,pr:`4px`,pl:0,borderColor:`muted`,borderBottomStyle:`solid`}},th:{verticalAlign:`bottom`,borderBottomWidth:`2px`,color:`heading`},td:{verticalAlign:`top`,borderBottomWidth:`1px`},hr:{mx:0}},layout:{container:{padding:[3,4],maxWidth:`1024px`}},text:{heading:{fontFamily:`heading`,fontWeight:`heading`,lineHeight:`heading`,color:`heading`}},copyButton:{backgroundColor:(0,theme_ui_color_esm/* transparentize */.DZ)(`primary`,0.8),border:`none`,color:`gray.2`,cursor:`pointer`,fontSize:[`14px`,`14px`,`16px`],fontFamily:`body`,letterSpacing:`0.025rem`,transition:`default`,"&[disabled]":{cursor:`not-allowed`},":not([disabled]):hover":{bg:`primary`,color:`white`},position:`absolute`,top:0,right:0,zIndex:1,borderRadius:`0 0 0 0.25rem`,padding:`0.25rem 0.6rem`},dividers:{bottom:{borderBottomStyle:`solid`,borderBottomWidth:`1px`,borderBottomColor:`divide`,pb:3},top:{borderTopStyle:`solid`,borderTopWidth:`1px`,borderTopColor:`divide`,pt:3}},links:{secondary:{color:`secondary`,textDecoration:`none`,":hover":{color:`heading`,textDecoration:`underline`},":focus":{color:`heading`}},listItem:{fontSize:[1,2,3],color:`text`}}});/* harmony default export */ const gatsby_plugin_theme_ui = (theme);
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/objectWithoutProperties.js
var objectWithoutProperties = __webpack_require__(45987);
// EXTERNAL MODULE: ./node_modules/mdx-utils/index.js
var mdx_utils = __webpack_require__(22033);
...
index_js_default().createContext();
...
var withChunkExtractor = function withChunkExtractor(Component) {
  var LoadableWithChunkExtractor = function LoadableWithChunkExtractor(props) {
    return index_js_default().createElement(Context.Consumer, null, function (extractor) {
      return index_js_default().createElement(Component, Object.assign({
...
function createLoadable(_ref) {
  ...
  function loadable(loadableConstructor, options) {
    ...
    function (_React$Component) {
      (0,inheritsLoose/* default */.Z)(InnerLoadable, _React$Component);
      ...
      _proto.resolveAsync = function resolveAsync() {
        var _this$props = this.props,
            ...
            props = (0,objectWithoutPropertiesLoose/* default */.Z)(_this$props, ["__chunkExtractor", "forwardedRef"]);
      ...
      _proto.render = function render() {
        var _this$props2 = this.props,
            ...
            props = (0,objectWithoutPropertiesLoose/* default */.Z)(_this$props2, ["forwardedRef", "fallback", "__chunkExtractor"]);
    ...
    var Loadable = index_js_default().forwardRef(function (props, ref) {
      return index_js_default().createElement(EnhancedInnerLoadable, Object.assign({
        forwardedRef: ref
      }, props));
    });
...
createLoadable({
  ...
  render: function render(_ref) {
    var Component = _ref.result,
        props = _ref.props;
    return index_js_default().createElement(Component, props);
  }
}),
...
;// CONCATENATED MODULE: ./node_modules/prism-react-renderer/themes/nightOwl/index.js
...
/* harmony default export */ const nightOwl = (nightOwl_theme);
...
/* harmony default export */ const copy_to_clipboard = (copyToClipboard);
...
const Copy = ({
  ...
  return (0,theme_ui_esm/* jsx */.tZ)("button", {
    type: "button",
    name: label,
    disabled: copied,
    ...
    onClick: async () => {
      await copy_to_clipboard(trim ? content.trim() : content);
      setCopied(true);
      await delay(duration);
      setCopied(false);
    }
  }, copied ? `Copied` : `Copy`, (0,theme_ui_esm/* jsx */.tZ)("span", {
    sx: utils/* visuallyHidden */.j,
...
const code_excluded = ["codeString", "noLineNumbers", "className", "metastring"];
...
function getParams(className = ``) {
  ...
  return [// @ts-ignore
  lang.split(`language-`).pop().split(`{`).shift()].concat( // @ts-ignore
  params.split(`&`).reduce((merged, param) => {
    const [key, value] = param.split(`=`); // @ts-ignore
...
const LazyLiveProvider = loadable_esm(async () => {
  const Module = await __webpack_require__.e(/* import() */ 153).then(__webpack_require__.bind(__webpack_require__, 153));
  const {
    LiveProvider,
    LiveEditor,
    LiveError,
  ...
  return props => /*#__PURE__*/index_js_.createElement(LiveProvider, props, props.showCopyButton && /*#__PURE__*/index_js_.createElement(copy, {
    content: props.code
  }), /*#__PURE__*/index_js_.createElement(LiveEditor, {
    "data-name": "live-editor"
  }), /*#__PURE__*/index_js_.createElement(LiveError, null), /*#__PURE__*/index_js_.createElement(LivePreview, {
...
const Code = _ref => {
  let {
    ...
    metastring = ``
      ...
      props = (0,objectWithoutProperties/* default */.Z)(_ref, code_excluded);

  const {
    showLineNumbers,
    showCopyButton
  } = (0,use_minimal_blog_config/* default */.Z)(); // @ts-ignore
  ...
  if (props[`react-live`]) {
    ...
    }, /*#__PURE__*/index_js_.createElement(LazyLiveProvider, {
      code: codeString,
      noInline: true,
      theme: nightOwl,
  ...
  return (
    /*#__PURE__*/
    // @ts-ignore
    index_js_.createElement(dist/* default */.ZP, Object.assign({}, dist/* defaultProps */.lG, {
      code: codeString,
      language: language,
      theme: nightOwl
    }), ({
      ...
      getLineProps,
      getTokenProps
    }) => /*#__PURE__*/index_js_.createElement(index_js_.Fragment, null, title && /*#__PURE__*/index_js_.createElement("div", {
      className: "code-title"
    }, /*#__PURE__*/index_js_.createElement("div", null, title)), /*#__PURE__*/index_js_.createElement("div", {
      className: "gatsby-highlight",
      "data-language": language
    }, /*#__PURE__*/index_js_.createElement("pre", {
      className: className,
      style: style,
      "data-linenumber": hasLineNumbers
    }, showCopyButton && /*#__PURE__*/index_js_.createElement(copy, {
      content: codeString,
      fileName: title
    }), /*#__PURE__*/index_js_.createElement("code", {
      ...
      return /*#__PURE__*/index_js_.createElement("div", lineProps, hasLineNumbers && /*#__PURE__*/index_js_.createElement("span", {
        className: "line-number-style"
      }, i + 1), line.map((token, key) => /*#__PURE__*/index_js_.createElement("span", getTokenProps({
        token,
        key
      }))));
    }))))))
...
;// CONCATENATED MODULE: ./node_modules/@lekoarts/gatsby-theme-minimal-blog/src/gatsby-plugin-theme-ui/components.js
const components_excluded=["children"],_excluded2=["children","text"];/* eslint react/prop-types: 0 */const components_components={Text:_ref=>{let{children}=_ref,props=(0,objectWithoutProperties/* default */.Z)(_ref,components_excluded);return/*#__PURE__*/index_js_.createElement(theme_ui_components_esm/* Text */.xv,props,children);},Title:_ref2=>{let{children,text}=_ref2,props=(0,objectWithoutProperties/* default */.Z)(_ref2,_excluded2);return/*#__PURE__*/index_js_.createElement(title/* default */.Z,Object.assign({text:text},props),children);},pre:preProps=>{const props=(0,mdx_utils/* preToCodeBlock */.u)(preProps);// if there's a codeString and some props, we passed the test
if(props){return/*#__PURE__*/index_js_.createElement(code,props);}// it's possible to have a pre without a code in it
return/*#__PURE__*/index_js_.createElement("pre",preProps);},wrapper:({children})=>/*#__PURE__*/index_js_.createElement(index_js_.Fragment,null,children)};/* harmony default export */ const gatsby_plugin_theme_ui_components = (components_components);
...
const Root=({children})=>{const themeUiConfig=configOptions();const{preset,prismPreset}=themeUiConfig;const theme=preset.default||preset;const themeWithPrism=(0,theme_ui_core_esm/* merge */.TS)(theme,{styles:{pre:prismPreset}});const fullTheme=(0,theme_ui_core_esm/* merge */.TS)(themeWithPrism,gatsby_plugin_theme_ui);return/*#__PURE__*/index_js_default().createElement(ThemeProvider,{theme:fullTheme,components:gatsby_plugin_theme_ui_components},children);};const WrapRootElement=({element})=>{return/*#__PURE__*/index_js_default().createElement(Root,null,element);};
;// CONCATENATED MODULE: ./node_modules/gatsby-plugin-theme-ui/gatsby-ssr.js
const onRenderBody=({setPreBodyComponents},{injectColorFlashScript=true})=>{if(injectColorFlashScript){setPreBodyComponents([(0,theme_ui_esm/* jsx */.tZ)(theme_ui_color_modes_esm/* InitializeColorMode */.sv,{key:'theme-ui-no-flash'})]);}};const wrapRootElement=({element})=>/*#__PURE__*/index_js_.createElement(WrapRootElement,{element:element});
...
var context = __webpack_require__(17796);
// EXTERNAL MODULE: ./node_modules/gatsby-plugin-mdx/loaders/mdx-components.js
var mdx_components = __webpack_require__(4818);
;// CONCATENATED MODULE: ./node_modules/gatsby-plugin-mdx/loaders/mdx-scopes.js
var scope_0=(__webpack_require__(76433)/* ["default"] */ .Z);/* harmony default export */ const mdx_scopes = (Object.assign({},scope_0));
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(57423);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var theme_ui__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(18733);
/* harmony import */ var theme_ui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17631);
/** @jsx jsx */
...
const Title = ({
  ...
  as = `h2`,
  className = ``
}) => (0,theme_ui__WEBPACK_IMPORTED_MODULE_1__/* .jsx */ .tZ)("div", {
  sx: {
...
}, (0,theme_ui__WEBPACK_IMPORTED_MODULE_1__/* .jsx */ .tZ)(theme_ui__WEBPACK_IMPORTED_MODULE_2__/* .Box */ .xu, {
  as: as,
  sx: {
    fontWeight: `medium`,
    fontSize: [3, 4],
  ...
  className: className
}, text), (0,theme_ui__WEBPACK_IMPORTED_MODULE_1__/* .jsx */ .tZ)("div", {
  sx: {
    color: `secondary`,
    a: {
...
const useMinimalBlogConfig = () => {
  const data = (0,gatsby__WEBPACK_IMPORTED_MODULE_0__.useStaticQuery)("3090400250");
...
*/
var aa=__webpack_require__(57423),m=__webpack_require__(24852),r=__webpack_require__(63840);function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b)}
...
if (true) {
  ...
  checkDCE();
  /* unused reexport */ __webpack_require__(64448);
} else {}
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(57423);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var object_assign__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(24852);
...
var React = __webpack_require__(57423);
...
/* harmony import */ var _theme_ui_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(92637);
...
"use strict";
module.exports = require("/Users/seonae/hyegithub/hye-design.github.io/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/Users/seonae/hyegithub/hye-design.github.io/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/seonae/hyegithub/hye-design.github.io/node_modules/react/index.js");
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-4dbba807cf0e1020619d.js"],"app":["/app-6054b134f59d6d1f8e32.js"],"component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-blog-query-tsx":["/component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-blog-query-tsx-23337d0619097ccab28a.js"],"component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-homepage-query-tsx":["/component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-homepage-query-tsx-ac50a0b01a03b75c84e7.js"],"component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-page-query-tsx":["/component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-page-query-tsx-ce92ae5d6044ef318ec5.js"],"component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-post-query-tsx":["/component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-post-query-tsx-60119947dae09a1b9155.js"],"component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-tags-query-tsx":["/component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-tags-query-tsx-3b01e06b592c989f6493.js"],"component---src-pages-404-jsx":["/component---src-pages-404-jsx-6f22133e5db2b4ddae86.js"]}');
...
/******/ 			return "" + ({"256":"component---src-pages-404-jsx","303":"component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-blog-query-tsx","366":"component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-homepage-query-tsx","677":"component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-page-query-tsx","688":"component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-post-query-tsx","726":"component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-tags-query-tsx"}[chunkId] || chunkId) + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);enumerableOnly&&(symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;})),keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=null!=arguments[i]?arguments[i]:{};i%2?ownKeys(Object(source),!0).forEach(function(key){(0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(target,key,source[key]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(target,Object.getOwnPropertyDescriptors(source)):ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}return target;}const React=__webpack_require__(57423);const path=__webpack_require__(71423);const{renderToString,renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(35677);const{ServerLocation,Router,isRedirect}=__webpack_require__(23631);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(37533);const fs=__webpack_require__(65323);const{WritableAsPromise}=__webpack_require__(65897);const{RouteAnnouncerProps}=__webpack_require__(70236);const{apiRunner,apiRunnerAsync}=__webpack_require__(84067);const asyncRequires=__webpack_require__(85418);const{version:gatsbyVersion}=__webpack_require__(21741);const{grabMatchParams}=__webpack_require__(39755);const chunkMapping=__webpack_require__(49804);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
const{join}=path.posix;// const testRequireError = require("./test-require-error")
// For some extremely mysterious reason, webpack adds the above module *after*
// this module so that when this code runs, testRequireError is undefined.
// So in the meantime, we'll just inline it.
const testRequireError=(moduleName,err)=>{const regex=new RegExp(`Error: Cannot find module\\s.${moduleName}`);const firstLine=err.toString().split(`\n`)[0];return regex.test(firstLine);};let Html;try{Html=__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../src/html'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));}catch(err){if(testRequireError(`../src/html`,err)){Html=__webpack_require__(89079);}else{throw err;}}Html=Html&&Html.__esModule?Html.default:Html;const getPageDataPath=path=>{const fixedPagePath=path===`/`?`index`:path;return join(`page-data`,fixedPagePath,`page-data.json`);};const getPageDataUrl=pagePath=>{const pageDataPath=getPageDataPath(pagePath);return`${""}/${pageDataPath}`;};const getStaticQueryPath=hash=>join(`page-data`,`sq`,`d`,`${hash}.json`);const getStaticQueryUrl=hash=>`${""}/${getStaticQueryPath(hash)}`;const getAppDataUrl=()=>`${""}/${join(`page-data`,`app-data.json`)}`;const createElement=React.createElement;const sanitizeComponents=components=>{const componentsArray=[].concat(components).flat(Infinity).filter(Boolean);return componentsArray.map(component=>{// Ensure manifest is always loaded from content server
