...
/* harmony default export */ const post_footer = (PostFooter);
...
const Post = ({
  ...
  }, (0,theme_ui_esm/* jsx */.tZ)("time", null, post.date), post.tags && (0,theme_ui_esm/* jsx */.tZ)(index_js_.Fragment, null, ` — `, (0,theme_ui_esm/* jsx */.tZ)(item_tags/* default */.Z, {
    tags: post.tags
  })), post.timeToRead && ` — `, post.timeToRead && (0,theme_ui_esm/* jsx */.tZ)("span", null, post.timeToRead, " min read")), (0,theme_ui_esm/* jsx */.tZ)("section", {
    sx: {
      my: 5,
  ...
  }, (0,theme_ui_esm/* jsx */.tZ)(gatsby_plugin_mdx.MDXRenderer, null, post.body)), (0,theme_ui_esm/* jsx */.tZ)(post_footer, {
    post: post
  }));
};
...
function MinimalBlogCorePost(_ref) {
  ...
  return /*#__PURE__*/index_js_.createElement(post, props);
}
;// CONCATENATED MODULE: ./node_modules/@lekoarts/gatsby-theme-minimal-blog-core/src/templates/post-query.tsx

/* harmony default export */ const post_query = (MinimalBlogCorePost);
